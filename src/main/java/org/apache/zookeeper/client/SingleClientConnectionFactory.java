...
public class SingleClientConnectionFactory extends ClientConnectionFactory {
	...
	public static SingleClientConnectionFactory create(
		...
		return new SingleClientConnectionFactory(connections, arguments, configuration);
	}
    ...
    @Inject
    protected SingleClientConnectionFactory(
            ClientConnectionGroup connections,
            Arguments arguments,
            Configuration configuration) throws Exception {
	...
	@Subscribe
	public synchronized void handleConnectionStateEvent(ConnectionStateEvent event) {
