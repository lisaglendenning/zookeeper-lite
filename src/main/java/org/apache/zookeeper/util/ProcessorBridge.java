...
public class ProcessorBridge<T,U,V> extends Pair<Processor<T,U>, Processor<U,V>> implements Processor<T,V> {
    
    public static <T,U,V> ProcessorBridge<T,U,V> create(Processor<T,U> first, Processor<U,V> second) {
