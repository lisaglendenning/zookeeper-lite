...
public class ConfigurableSocketAddress implements Configurable {
    ...
    public static ConfigurableSocketAddress create(String addressKey, String defaultAddress, 
            String portKey, int defaultPort) {
        return new ConfigurableSocketAddress(addressKey, defaultAddress, portKey, defaultPort);
    }
    ...
    public ConfigurableSocketAddress(String addressKey, String defaultAddress, 
            String portKey, int defaultPort) {
        this.PARAM_ADDRESS = Parameters.newParameter(addressKey, defaultAddress);
        this.PARAM_PORT = Parameters.newParameter(portKey, defaultPort);
        this.parameters = Parameters.newInstance()
                .add(PARAM_ADDRESS).add(PARAM_PORT);
    }
    ...
    public SocketAddress socketAddress() {
        ...
        SocketAddress socketAddress = (address == PARAM_DEFAULT_ADDRESS) 
