...
public class OpErrorProcessor implements Processor<Operation.Request, Operation.Response> {
    ...
    public static OpErrorProcessor create(Processor<Operation.Request, Operation.Response> processor) {
        return new OpErrorProcessor(processor);
    }
    
    protected Processor<Operation.Request, Operation.Response> processor;
    
    protected OpErrorProcessor(Processor<Operation.Request, Operation.Response> processor) {
    ...
    public Operation.Response apply(Operation.Request request) throws Exception {
        ...
        try {
            ...
            response = OpError.create(OpAction.Response.create(request.operation()), e.code());
        }
        return response;
    }
}
