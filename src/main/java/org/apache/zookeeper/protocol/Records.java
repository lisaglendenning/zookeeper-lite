...
public class Records {
    ...
    protected static BiMap<Operation, Class<? extends Record>> requestTypes = EnumHashBiMap.create(Operation.class);
    static {
    ...
    protected static BiMap<Operation, Class<? extends Record>> responseTypes = EnumHashBiMap.create(Operation.class);
    static {
    ...
    public static class Headers {
        ...
        public static RequestHeader deserialize(RequestHeader header, InputStream stream) throws IOException {
            return Records.deserialize(header, stream, TAG);
        }

        public static ReplyHeader deserialize(ReplyHeader header, InputStream stream) throws IOException {
            return Records.deserialize(header, stream, TAG);
        }

        public static OutputStream serialize(RequestHeader header, OutputStream stream) throws IOException {
            return Records.serialize(header, stream, TAG);
        }

        public static OutputStream serialize(ReplyHeader header, OutputStream stream) throws IOException {
            return Records.serialize(header, stream, TAG);
        }
    }
    ...
    public static class Requests {
        ...
        public static class Headers {
            ...
            public static RequestHeader deserialize(InputStream stream) throws IOException {
                return Records.deserialize(create(), stream, TAG);
            }
            
            public static OutputStream serialize(int xid, int type, OutputStream stream) throws IOException {
                return Records.Headers.serialize(create(xid, type), stream);
            }
            
            public static OutputStream serialize(int xid, Operation op, OutputStream stream) throws IOException {
        ...
        public static Operation recordToOperation(Class<? extends Record> recordType) {
            Map<Class<? extends Record>, Operation> typeMap = requestTypes.inverse();
        ...
        public static <T extends Record> T deserialize(T request, InputStream stream) throws IOException {
            return Records.deserialize(request, stream, TAG);
        }
        
        @SuppressWarnings("unchecked")
        public static <T extends Record> T deserialize(Operation op, InputStream stream) throws IOException {
            return deserialize((T) create(op), stream);
        }
        
        public static OutputStream serialize(Record request, OutputStream stream) throws IOException {
    ...
    public static class Responses {
        ...
        public static class Headers {
            ...
            public static ReplyHeader create(int xid, long zxid, KeeperException.Code code) {
                return create(xid, zxid, code.intValue());
            }

            public static ReplyHeader deserialize(InputStream stream) throws IOException {
                return Records.Headers.deserialize(create(), stream);
            }
            
            public static OutputStream serialize(int xid, long zxid, int err, OutputStream stream) throws IOException {
                return Records.Headers.serialize(create(xid, zxid, err), stream);
            }
            
            public static OutputStream serialize(int xid, long zxid, KeeperException.Code code, OutputStream stream) throws IOException {
                return Records.Headers.serialize(create(xid, zxid, code), stream);
            }
        }
        ...
        public static Operation recordToOperation(Class<? extends Record> recordType) {
            Map<Class<? extends Record>, Operation> typeMap = responseTypes.inverse();
            Operation operation = typeMap.get(recordType);
            return operation;
        }
        ...
        public static <T extends Record> T deserialize(T response, InputStream stream) throws IOException {
        ...
        public static OutputStream serialize(Record response, OutputStream stream) throws IOException {
    ...
    public static <T extends Record> T deserialize(T record, InputStream stream) throws IOException {
        return deserialize(record, stream, recordToTag(record));
    }

    public static <T extends Record> T deserialize(T record, InputStream stream, String tag) throws IOException {
        BinaryInputArchive bia = BinaryInputArchive.getArchive(stream);
        record.deserialize(bia, tag);
        return record;
    }

    public static <T extends Record> OutputStream serialize(T record, OutputStream stream) throws IOException {
        return serialize(record, stream, recordToTag(record));
    }

    public static <T extends Record> OutputStream serialize(T record, OutputStream stream, String tag) throws IOException {
    ...
    public static String toString(Record record) {
        return Objects.toStringHelper(record)
                .addValue(record.toString().replaceAll("\\s",""))
                .toString();
    }
