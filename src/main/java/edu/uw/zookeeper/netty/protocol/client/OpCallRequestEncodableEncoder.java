...
import edu.uw.zookeeper.data.Operation.CallRequest;
import edu.uw.zookeeper.protocol.Encodable;
import edu.uw.zookeeper.protocol.client.OpCallRequestEncoder;
...
public class OpCallRequestEncodableEncoder extends
        MessageToMessageEncoder<Operation.CallRequest> {
