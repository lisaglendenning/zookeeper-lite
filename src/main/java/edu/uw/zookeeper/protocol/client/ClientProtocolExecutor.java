 ...
 */
public class ClientProtocolExecutor implements Eventful, SessionRequestExecutor, Stateful<ProtocolState> {

    public static ClientProtocolExecutor newSession(
    ...
    public static ClientProtocolExecutor renewSession(
            ClientCodecConnection codecConnection,
            Reference<Long> lastZxid,
            Session session) {
