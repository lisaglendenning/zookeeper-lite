...
import org.apache.zookeeper.protocol.netty.LoggingDecoder;
import org.apache.zookeeper.protocol.netty.TestEmbeddedChannels;
import org.apache.zookeeper.protocol.netty.client.AnonymousClientConnection;
...
public class ServerConnectionITest extends TestEmbeddedChannels {
    ...
    public void testCreateSession() throws Exception {
        ...
        Operation.Result<OpCreateSessionAction.Request, OpCreateSessionAction.Response> createOutput = writeInboundAndRead(clientChannel, serverMsg);
    ...
    public void testCreatePingCloseSession() throws Exception {
        ...
        Operation.Result<Operation.CallRequest, Operation.Response> closeResponseInput = OpResult.create(closeRequestInput, closeResponse);
        serverMsg = writeOutboundAndRead(serverChannel, closeResponseInput);
        Operation.CallResult<Operation.CallRequest, Operation.CallResponse> closeResponseOutput = writeInboundAndRead(clientChannel, serverMsg);
        ...
        assertEquals(closeResponse, ((Operation.ResponseValue<Operation.Response>)closeResponseOutput.response()).response());
    }
}
