...
public class ConnectionManagerTest {
    ...
    protected final Logger logger = LoggerFactory.getLogger(ConnectionManagerTest.class);
    ...
    public static class Module extends LocalModule {
        ...
        public static void createInjector() {
            injector = Guice.createInjector(
                    ...
                    ExpiringSessionManager.Module.get(),
                    Module.get());
        }
        ...
        protected void configure() {
            ...
            bind(RequestExecutorService.Factory.class).to(RequestExecutorFactory.class);
        }
    ...
    public void testConnect() throws Exception {
        ...
        RequestExecutorFactory requests = injector.getInstance(RequestExecutorFactory.class);
